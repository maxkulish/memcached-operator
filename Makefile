...
# memcached.example.com/memcached-operator-bundle:$VERSION and memcached.example.com/memcached-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= memcached.example.com/memcached-operator
